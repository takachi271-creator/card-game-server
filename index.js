...
function calcMultiplier(amount,startMoney){

const percent=(amount/startMoney)*100
...
const multi = calcMultiplier(winnerBet,game.startMoney)

/* 獲得額 */

const reward = Math.floor(pot * multi)
